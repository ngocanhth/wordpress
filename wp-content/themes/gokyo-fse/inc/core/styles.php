 ...
 * @return void
 */
function gokyo_fse_get_color_value( $value ) {
...
function gokyo_fse_global_styles_vars() {
	...
	if ( ! empty( $core_button_styles['color']['background'] ) ) {
		$element_css_styles .= '--wp--custom--core-button--color--background: ' . gokyo_fse_get_color_value( $core_button_styles['color']['background'] ) . ';';
	}

	if ( ! empty( $core_button_styles['color']['text'] ) ) {
		// var(--wp--preset--color--vivid-red)
		$element_css_styles .= '--wp--custom--core-button--color: ' . gokyo_fse_get_color_value( $core_button_styles['color']['text'] ) . ';';
	}
...
add_action( 'wp_enqueue_scripts', 'gokyo_fse_global_styles_vars', 100 );
